...
const page = () => {
  const counterItems = [
    { id: 1, title: "Year of Experience", value: 4 },
    { id: 2, title: "Project Completed", value: 10 },
    // { id: 3, title: "Happy Client", value: 72 },
  ];
  const about = {
    name: "Carolyn Ho",
    bio: " A <b>Web designer</b> 🖥️ having <b>4 years </b> of Experiences. Focused on executing designs with precision to detail.",
  };
